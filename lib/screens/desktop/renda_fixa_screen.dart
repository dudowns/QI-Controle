// lib/screens/desktop/renda_fixa_screen.dart
  ...
  Future<void> _adicionarValorInvestimento(RendaFixaModel inv) async {
    ...
    if (confirmar == true && valorController.text.isNotEmpty) {
      try {
        ...
        if (valorAdicional <= 0) throw Exception('Valor invalido');
                                  ...
                                  Text('Nenhum investimento em renda fixa',
                                      style: TextStyle(
                                          color: AppColors.textSecondary(
                                              context))),
                                  const SizedBox(height: 8),
                                  Text('Toque em ADICIONAR para comecar',
                                      style: TextStyle(
                                          fontSize: 12,
                                          color: AppColors.textSecondary(
                                              context))),
          ...
          child: Row(children: [
            ...
            Expanded(
                child: Column(
                  ...
                  const SizedBox(height: 2),
                  Text(
                      '${_getTaxaFormatada(inv)} - ${inv.liquidezDiaria ? "Liquidez Diaria" : "No vencimento"}',
